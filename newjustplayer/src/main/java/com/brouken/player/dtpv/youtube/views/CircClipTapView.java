 ...
 * Used by [YTOverlay][com.github.vkay94.dtpv.youtube.YTOverlay].
 */
public final class CircClipTapView extends View {
    ...
    public CircClipTapView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ...
        backgroundPaint.setColor(ContextCompat.getColor(context, com.github.vkay94.dtpv.R.color.dtpv_yt_background_circle_color));

        circlePaint.setStyle(Paint.Style.FILL);
        circlePaint.setAntiAlias(true);
        circlePaint.setColor(ContextCompat.getColor(context, com.github.vkay94.dtpv.R.color.dtpv_yt_tap_circle_color));
