        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            layout.setOnApplyWindowInsetsListener((view, windowInsets) -> {
                view.setPadding(windowInsets.getSystemWindowInsetLeft(),
                        ...
                        0);
                if (rv != null) {
                    rv.setPadding(0,0,0, windowInsets.getSystemWindowInsetBottom());
                }
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            if (preferenceAutoPiP != null) {
                preferenceAutoPiP.setEnabled(Utility.isPiPSupported(this.getContext()));
            }
            ...
            if (listPreferenceFileAccess != null) {
                ...
                if (!Utility.hasSAFChooser(getContext().getPackageManager())) {
            ...
            if (listPreferenceLanguageSub != null) {
                ...
                entries.put(SPHandler.TRACK_DEFAULT, getString(R.string.pref_language_track_default));
                entries.put(SPHandler.TRACK_DEVICE, getString(R.string.pref_language_track_device));
                entries.put(SPHandler.TRACK_NONE, getString(R.string.pref_language_track_none));
        ...
        LinkedHashMap<String, String> getLanguages() {
            ...
            Utility.orderByValue(languages, collator::compare);
            return languages;
        }
    }
}