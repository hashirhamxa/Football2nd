...
class SPHandler {
    ...
    private void loadSavedPreferences() {
        ...
        orientation = Utility.Orientation.values()[mSharedPreferences.getInt(PREF_KEY_ORIENTATION, orientation.value)];
    ...
    public long getPosition() {
        ...
        if (ContentResolver.SCHEME_CONTENT.equals(mediaUri.getScheme())) {
            final String searchPath = SubtitleUtility.getTrailPathFromUri(mediaUri);
            ...
            for (int i = keys.length; i > 0; i--) {
                ...
                if (ContentResolver.SCHEME_CONTENT.equals(uri.getScheme())) {
                    final String keyPath = SubtitleUtility.getTrailPathFromUri(uri);
