...
import livefootball.footballstreamning.fifaworldcup.adapters.MainPagerAdapter
        ...
        lifecycleScope.launch {
            ...
            ads.find { it.adPlacement.equals("Interstitial", ignoreCase = true) }?.let { ad ->
                if (ad.isActive == true && !ad.adUnitId.isNullOrEmpty()) {
                    AdsHelper.getInstance(this@NewMainActivity).preloadAdADMOB_X_Inter(this@NewMainActivity, ad.adUnitId)
                }
            }
            ...
            ads.find { it.adPlacement.equals("Rewarded", ignoreCase = true) }?.let { ad ->
                if (ad.isActive == true && !ad.adUnitId.isNullOrEmpty()) {
                    AdsHelper.getInstance(this@NewMainActivity).preloadRewardedAd(this@NewMainActivity, ad.adUnitId)
                }
            }
        }
    }
            ...
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                launch {
                    combine(viewModel.appConfig, viewModel.streamingConfig) { app, streaming ->
                        ...
                        if (app != null) {
                            DialogManager.checkAndShowDialog(this@NewMainActivity, app, streaming, false)
                        }
                    }
                }
