...
class TournamentListAdapter(private val items: List<DashboardMatchItem>, private val isHighlightsMode: Boolean = false) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val liveBadgeText: TextView = view.findViewById(R.id.text_live_badge_text)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (item.isLive) {
            holder.liveBadgeText.text = "LIVE"
            ...
            holder.liveBadgeText.text = "UPCOMING"
        ...
        holder.container.setOnClickListener {
            ...
            when (context) {
                is TournamentListActivity -> {
                    val intent = Intent(context, EventsListActivity::class.java).apply {
                        putExtra("TOURNAMENT_ID", item.eventId) // This might be tournamentId in DashboardMatchItem
