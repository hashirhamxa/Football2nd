package livefootball.footballstreamning.fifaworldcup.feature.matches.ui.upcoming;
...
import livefootball.footballstreamning.fifaworldcup.app.ui.OnMatchClickListener;
...
public class UpcomingMatchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == DateGroupUtils.DisplayItem.TYPE_HEADER) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_upcoming_date_header, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof HeaderViewHolder) {
            ...
            matchHolder.matchTimeText.setText(match.matchTime);
    ...
    static class MatchViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView leagueName, homeTeamName, awayTeamName, matchTimeText;
        ...
        public MatchViewHolder(@NonNull View itemView) {
            ...
            matchTimeText = itemView.findViewById(R.id.match_time_text);
        }
    }
}
