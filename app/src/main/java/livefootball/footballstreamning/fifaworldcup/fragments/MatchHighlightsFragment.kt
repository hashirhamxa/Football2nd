...
import livefootball.footballstreamning.fifaworldcup.viewmodels.MatchHighlightsViewModel
...
/**
 * MatchHighlightsFragment (History): Displays archived highlight matches for Cricket, Football, and Other sports.
 * Mirrors HomeFragment's dynamic multi/single layout logic.
 */
@AndroidEntryPoint
class MatchHighlightsFragment : Fragment() {

    private val viewModel: MatchHighlightsViewModel by viewModels()
                    ...
                    viewModel.sections.collectLatest { sections ->
                        ...
                        if (isSingle && sections.isNotEmpty()) {
                            ...
                            rvSingle.apply {
                                ...
                                adapter = SportCategoryAdapter(section.items, true, true) { handleItemClick(it) }
                            }
                        } else {
                                ...
                                when (section.sportType) {
                                    "cricket" -> {
                                        ...
                                        rvCricket.apply {
                                            ...
                                            adapter = SportCategoryAdapter(section.items, false, true) { handleItemClick(it) }
                                        }
