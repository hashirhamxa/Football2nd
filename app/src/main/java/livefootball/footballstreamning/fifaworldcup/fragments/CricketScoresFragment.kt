...
import livefootball.footballstreamning.fifaworldcup.adapters.CricketScoreListAdapter
import livefootball.footballstreamning.fifaworldcup.ads.AdsHelper
import livefootball.footballstreamning.fifaworldcup.viewmodels.CricketScoresViewModel

@AndroidEntryPoint
class CricketScoresFragment : Fragment() {

    private val viewModel: CricketScoresViewModel by viewModels()
            ...
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                launch {
                    viewModel.matches.collectLatest { matches ->
                        rvMatches.adapter = CricketScoreListAdapter(matches) { match ->
