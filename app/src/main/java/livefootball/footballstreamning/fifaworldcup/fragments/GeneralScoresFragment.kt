...
@AndroidEntryPoint
class GeneralScoresFragment : Fragment() {

    private val mainViewModel: HomeDashboardViewModel by activityViewModels()
    ...
    private fun updateChildFragment(type: String?) {
        val fragment = when (type) {
            "cricket" -> CricketScoresFragment()
            "football" -> FootballScoresFragment()
            else -> null
        }
