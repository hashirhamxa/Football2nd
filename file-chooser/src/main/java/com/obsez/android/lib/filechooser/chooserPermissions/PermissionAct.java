...
public class PermissionAct extends AppCompatActivity {
    ...
    private static final String TAG = PermissionAct.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _permissionListener = PermissionsUtility.getPermissionListener(_requestCode);
    ...
    @Nullable
    private PermissionsUtility.OnPermissionListener _permissionListener;
